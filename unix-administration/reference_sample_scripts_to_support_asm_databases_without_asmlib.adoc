...
summary: 'Les exemples de scripts sont disponibles dans le répertoire plugins/examples/noasmlib du répertoire d"installation de SnapManager pour Oracle.' 
---
...
[role="lead"]
Les exemples de scripts sont disponibles dans le répertoire plugins/examples/noasmlib du répertoire d'installation de SnapManager pour Oracle.
