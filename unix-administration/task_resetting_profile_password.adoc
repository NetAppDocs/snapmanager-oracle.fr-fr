...
. Réinitialisez le mot de passe du profil en saisissant la commande suivante : « mot de passe Mo reset -profileprofile [-profile-passwordprofile_password] [-référentiel-hostadmin-passwordadmin_password] »
